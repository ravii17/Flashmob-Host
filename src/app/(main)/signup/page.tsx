    ...
    <div className="min-h-[75vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-slate-100 shadow-premium animate-scale-up">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-500">Sign up now to start joining and organizing flashmobs</p>
        </div>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          {/* Instagram Username */}
          <div className="space-y-1.5">
            <label htmlFor="instagram" className="text-xs font-bold text-slate-500 uppercase tracking-wider block">
              Instagram Username <span className="text-slate-400 font-semibold">(Optional)</span>
            </label>
            <div className="relative">
              <InstagramIcon className="absolute left-3 top-3 h-4.5 w-4.5 text-slate-400" />
              <input
                id="instagram"
                name="instagram"
                type="text"
          ...
          >
            {submitLoading ? <Spinner size="sm" className="border-t-white" /> : 'Get Started'}
          </button>
        </form>
        ...
        <div className="text-center text-sm pt-4 border-t border-slate-50">
          ...
          <Link href="/login" className="text-blue-600 hover:underline font-bold transition-all">
            Sign in
          </Link>
        </div>
      </div>
